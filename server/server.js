...
// Serve static files from the public directory (where the React app is built to)
const path = require("path");
app.use(express.static(path.join(__dirname, "public")));

// Any other route not handled by the API will be served by the React app
app.get("*", (req, res) => {
...
// Database Connection
mongoose
  .connect(process.env.MONGO_URI || "mongodb://localhost:27017/healthsync")
